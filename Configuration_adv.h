...
/* Extruder runout prevention. If the machine is idle and the temperature over MINTEMP
...
/* This is for controlling a fan to cool down the stepper drivers - it will turn on when any driver is enabled
//and turn off after the set amount of seconds from last driver being disabled again */
#define CONTROLLERFAN_PIN -1 /*Pin used for the fan to cool controller (-1 to disable) */
#define CONTROLLERFAN_SECS 60 /*How many seconds, after all motors were disabled, the fan should run */
#define CONTROLLERFAN_SPEED 255  /* == full speed */

/* When first starting the main fan, run it at full speed for the given number of milliseconds.  This gets the fan 
   spinning reliably before setting a PWM value. (Does not work with software PWM for fan on Sanguinololu) */
//#define FAN_KICKSTART_TIME 100

/* This defines the minimal speed for the main fan, run in PWM mode to enable uncomment and set minimal PWM speed 
   for reliable running (1-255) if fan speed is [1 - (FAN_MIN_PWM-1)] it is set to FAN_MIN_PWM  */
...
//#define CASE_LIGHT_PIN 4
  ...
  /* Uncomment to have a Case Light On / Off entry in main menu */
...
/* Enable this for dual x-carriage printers. A dual x-carriage design has the advantage that the inactive extruder 
   can be parked which prevents hot-end ooze contaminating the print. It also reduces the weight of each x-carriage
...
/* Default stepper release if idle. Set to 0 to deactivate. Steppers will shut down DEFAULT_STEPPER_DEACTIVE_TIME seconds after 
   the last move when DISABLE_INACTIVE_? is true. Time can be set by M18 and M84. */
...
/* Frequency limit - See nophead's blog for more info
// Not working O */
...
/*Pin for triggering CHDK to take a picture see how to use it here http://captain-slow.dk/2014/03/09/3d-printing-timelapses/ */
//#define CHDK 4        
...
/* Babystepping enables the user to control the axis in tiny amounts, independently from the normal printing process
   it can e.g. be used to change z-positions in the print startup phase in real-time _ WARNING!!! - does not respect endstops! */
//#define BABYSTEPPING
#if ENABLED(BABYSTEPPING)
  #define BABYSTEP_XY  /*not only z, but also XY in the menu. more clutter, more functions not implemented for deltabots! */
...
//#define ENSURE_SMOOTH_MOVES
  ...
  /* If enabled, the menu will always be responsive. - WARNING: Menu navigation during short moves may cause stuttering! */

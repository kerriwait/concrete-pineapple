...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160, 160, 6400,1330}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {400, 400, 2, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {900,900,25,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
